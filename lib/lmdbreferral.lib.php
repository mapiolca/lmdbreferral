...
function lmdbreferralPrintLinkStatsBlock(array $stats)
{
	...
	print '<td class="titlefield">'.$langs->trans('LmdbReferralSignedAmountTTC').'</td>';
	...
	print '<td class="titlefield">'.$langs->trans('LmdbReferralFirstSignatureDate').'</td>';
	...
	print '<td class="titlefield">'.$langs->trans('LmdbReferralDaysToFirstSignature').'</td>';
