...
if ($action === 'save') {
	...
	$constants = array(
		...
		'LMDBREFERRAL_USE_REFERRED_THIRDPARTY_CREATION_DATE' => GETPOSTINT('LMDBREFERRAL_USE_REFERRED_THIRDPARTY_CREATION_DATE'),
...
lmdbreferral_print_setup_yesno('LMDBREFERRAL_USE_REFERRED_THIRDPARTY_CREATION_DATE', 'LmdbReferralUseReferredThirdpartyCreationDate', 1);
